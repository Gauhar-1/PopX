...
export default function AccountSettings() {
  ...
  const user = {
    name: "Marry Doe",
    email: "Marry@Gmail.Com", // As per PRD, casing is important
    avatarUrl: "https://placehold.co/64x64.png", // Placeholder image
    bio: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
  };

  return (
    <div className="min-h-screen bg-popx-bg">
      {/* Header Bar */}
      <header className="bg-popx-white h-[56px] shadow-sm flex items-center px-4 sm:px-6 sticky top-0 z-10 md:relative">
      ...
      <main className="p-4 sm:p-6">
        <div className="max-w-3xl mx-auto"> {/* Optional: constrain width on larger screens */}
